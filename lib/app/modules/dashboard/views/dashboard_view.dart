...
import 'package:bips_app/app/modules/Employe/views/map_main_view.dart';
...
import 'package:bips_app/app/modules/profilesetting/views/main_profile_setting_view.dart';
    ...
    return Scaffold(
        ...
        body: Obx(() {
          if (controller.activeBottomIndex.value == 0) {
            ...
            return const MainProfileSettingView();
          } else {
            return const HomeSubViewss();
          }
        }));
